      ...
      <div class="space-y-12 mx-60">
        ...
        <div class="border-b border-gray-900/10 pb-12">
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-4">
              <label  class="block text-sm font-medium leading-6 text-gray-900">Password Confirm</label>
              <div class="mt-2">
...
<!--        </div>-->
  ...
  export default {
    ...
    data(){
      return{
        user:{
          firstName: '',lastName:'', email:'', phoneNumber:'', gender:'', avatar: File,username:'',password:''
        },
      }
    },
    methods:{
       async register(){
        this.getAvatar()
        let mess =  await AuthService.register(this.user)
        if (mess === 'User register success')
          await router.push('/login')
        else document.getElementById('messageResponse').innerHTML=mess
         console.log(mess)
      },
