    ...
    <div class="container h-full px-6 py-24">
      <div
        ...
        <div class="md:w-8/12 lg:ml-6 lg:w-5/12">
          <form>
            <!-- Email input -->
            <div class="relative mb-6 focus-within:shadow-lg">
              <label for="">Username</label>
             <input type="text"
             class="border-slate-200 w-full"
             required="true"
            ...
            <p id="messageResponse" class="text-red-600"></p>
...
<!--            Register-->
            ...
            <p class="inline">Chưa có tài khoản ?? </p><router-link class="inline " :to="{name:'Register'}">Register</router-link>
        </div>
      </div>
    </div>
  </section>
  ...
  <script setup>
  // import { PhotoIcon, UserCircleIcon } from '@heroicons/vue/24/
